...
class CallCenter(object):
    ...
    def dispatch_call(self, caller, get_available_employee):
        call = Call(caller)
        self.call_database[call.start_time] = call
        self._dispatch_call(call, get_available_employee)
   
    def _dispatch_call(self, call, get_available_employee):
    ...
    def get_available_employee(self, call): 
        pass
